(function () {
    ...
    var Uakino = {
        ...
        search: function (query, callback) {
            ...
            if (typeof network !== 'undefined' && network.silent) {
                ...
                console.error('Uakino: network.silent недоступний');
                callback([]);
            }
        },
    ...
    if (typeof Lampa !== 'undefined') {
        console.log('Uakino: Lampa визначена');
        ...
        console.error('Uakino: Lampa не визначена');
    }
